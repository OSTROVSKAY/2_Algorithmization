...
public class Task_4_9 {
	...
	public static void main(String[] args) {
		...
		// Ввод длин ЧЕТЫРЁХ сторон четырехугольника : X, Y, Z, Т
		System.out.println("--------------------------------------------------------");
		System.out.println("Ввод длин ЧЕТЫРЁХ сторон четырехугольника - X, Y, Z, Т :");
		System.out.println("--------------------------------------------------------");
		...
		System.out.println("-------------------------------------------------");
		System.out.println("Введите длину ПЕРВОЙ стороны четырехугольника : X");
		System.out.println("-------------------------------------------------");
		...
		System.out.println("-------------------------------------------------");
		System.out.println("Введите длину ВТОРОЙ стороны четырехугольника : Y");
		System.out.println("-------------------------------------------------");
		...
		System.out.println("--------------------------------------------------");
		System.out.println("Введите длину ТРЕТЬЕЙ стороны четырехугольника : Z");
		System.out.println("--------------------------------------------------");
		...
		System.out.println("--------------------------------------------------");
		System.out.println("Введите длину ТРЕТЬЕЙ стороны четырехугольника : Т");
		System.out.println("--------------------------------------------------");

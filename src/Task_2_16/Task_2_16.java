...
public class Task_2_16 {
	...
	public static void main(String[] args) {
		...
		if ( N%2 !=0 ) {
			...
			matrix = object1.magicSquareOfOddOrder(N);
			...
			matrix = object1.magicSquareOfEvenOddOrder(N);
			...
			matrix = object1.evenMatrixSquare(N);
		...
		int check = object1.TestMass( matrix, M, N );
